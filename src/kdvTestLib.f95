...
subroutine LTStepTestGradient(N, Ntrc, L, dt, nDtParam, maxPower, &
    ...
    double precision, dimension(N)  ::  xSeed 
    double precision                ::  L, res, pAmp, dt, &
                                        tRealFct, tRealGrad, &
                                        eps, Jeps, J0
    ...
    spinUp=kdvPropagator(N, Ntrc, L, dt, nSpinUp, nDtParam, tRealFct,&
                            xSeed, alph, beta, gamm, rho, forc)
    ...
    J0=fctCout(N, Ntrc, L, dt, tRealFct, u, xBuff, &
                        alph(nSpinUp+1,:), beta(nSpinUp+1,:),&
                        gamm(nSpinUp+1,:), rho(nSpinUp+1,:), &
                        forc(nSpinUp+1,:))
